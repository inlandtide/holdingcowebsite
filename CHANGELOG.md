...
### Changed
- Smoothed the transition from the blue hero into the acquisition targets section by placing the light content inside a bordered parchment panel on the continued navy background.
